...
public class Rectangle 
{
	...
	public void move(String direction, GameArena arena, double amount){
		
		arena.removeRectangle(this);

		if (direction == "Up"){
			this.setYPosition(this.yPosition-amount);
		}
		...
		if (direction == "Left"){
			this.setXPosition(this.xPosition-amount);
		}
		if (direction == "Right"){
			this.setXPosition(this.xPosition+amount);
		}
